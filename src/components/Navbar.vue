  ...
  <header>
    ...
    >
      ...
      <div class="md:flex justify-between items-center hidden">
        <ul class="flex justify-between items-center gap-12">
          <li
            v-for="link in links"
            :key="link.id"
            class="uppercase text-dark-blue font-normal tracking-[1px] hover:text-soft-red duration-300"
          >
            <a :href="link.to">
              {{ link.name }}
            </a>
      ...
      <div class="flex justify-center items-center md:hidden">
        <span
          class="material-symbols-outlined text-3xl text-dark-blue font-bold"
          @click="toggleMenu"
        >
          menu
        </span>
    ...
    <transition name="slide">
      <div
        v-if="showMenu"
        class="fixed inset-0 w-screen h-screen flex justify-center items-center bg-dark-blue/100 z-50"
      >
        <div class="w-[375px] h-full text-center">
          <div class="flex flex-col justify-between py-8 px-8">
            <div class="flex justify-between items-center">
              ...
              <span
                class="material-symbols-outlined text-3xl text-white font-bold"
                @click="toggleMenu"
                >close</span
              >
            </div>
